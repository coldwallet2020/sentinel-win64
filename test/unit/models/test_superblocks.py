...
def go_list_proposals():
    items = [
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "TEjMnhB5mAPrpg7R4CUCSGQNnJqPeAFBTH", "payment_amount": 32.01, "start_epoch": 1474261086, "type": 1, "url": "http://billiecoin.org"}]]',
...
def go_list_superblocks():
    items = [
        {u'AbsoluteYesCount': 1,
         ...
         u'DataString': u'[["trigger", {"event_block_height": 72696, "payment_addresses": "TSTfeMeWwQiCDwMSTWRaj9wwVGNjZFfvFk|TSTfeMeWwQiCDwMSTWRaj9wwVGNjZFfvFk", "payment_amounts": "25.75000000|25.7575000000", "type": 2}]]',
...
def test_deterministic_superblock_creation(go_list_proposals):
    ...
    sb = billiecoinlib.create_superblock(prop_list, 72000, max_budget, misc.now(), maxgovobjdatasize)
